    ...
    <div className="MStride">
      ...
      <div className="SideBar">
        ...
        <ul className="Links-List">
          <li>
            <a
              href="https://mahamitra.org/districts"
              target="_blank"
      ...
      <div className="Content">
        ...
        <div className="stat-strip">
          ...
          <div className="stat-card">
            ...
            <label>Total Usage - (as per Feb 2026)</label>
          </div>
          <div className="stat-card">
            <span>11.0%</span>
            <label>DLI Achievement (as per Feb 2026)</label>
          </div>
          <div className="stat-card">
            <span>₹1,562 Cr</span>
        ...
        <div className="PageContent">
          <p>
            Maharashtra Institution for Transformation (MITRA) has embarked upon
            an ambitious initiative, funded by The World Bank Group, to
            ...
            million) and out of the total funds required for the implementation
            of the project, 70% (estimated Rs 1,562 crore / USD 188.28 million)
            will be financed by loans from the World Bank and the remaining 30%
            (estimated Rs 670 crore/ USD 80.69 million) will be provided by the
            state government.
            <br />
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    Strategic Plans (“DSPs”) through an incentive framework that
                    will trigger fiscal rewards to districts that achieve
                    ...
                    sectors; and (d) annual performance evaluations of the DSPs
                    to allow implementation gaps/ challenges to be timely
                    addressed.{" "}
                  </p>
                </li>
                <li>
                  ...
                  <p>
                    ...
                    existing management information systems (“MIS”) to enable a
                    consolidated view of fund flows and details of
                    schemes/programs under implementation in districts,
                    including the Maharashtra Planning Schemes Information
                    Management System (“MPSIMS”), the Integrated Planning Office
                    Automation System (“iPAS”), the DSP Monitoring and
                    ...
                    building a dynamic Statistical Business Register (“SBR”) to
                    enable tracking of district level business development and
                    economic activity; (d) collecting data on new socio-economic
                    indicators through new surveys; and (e) launching a
                    geoportal for districts including the geo spatial data
                    layers created and maintained by the Maharashtra Remote
                    Sensing Application Centre (“MRSAC”), all these data sets to
                    feed into an integrated district data dashboard that will
                    allow tracking of physical and financial progress of DSP
                    implementation.
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  ...
                  <p>
                    ...
                    MAITRI portal; and (d) prioritizing onboarding of government
                    services in the tourism sector onto the Maharashtra
                    Industry, Trade, and Investment Facilitation Act (“MAITRI”)
                    portal.
                  </p>
                </li>
                <li>
                  <u>
                    Improved delivery timelines, timeliness, and accountability:
                  </u>
                  <br />
                  <p>
                    Support for: (a) conducting process re-engineering to
                    streamline processes and eliminate unnecessary approvals and
                    other bottlenecks; (b) close monitoring of the timeliness of
                    service delivery; and (c) gathering and disclosing
                    beneficiary feedback on services delivered to improve
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  <br />
                  <p>
                    Support for: (a) the creation of a conducive data governance
                    architecture in Maharashtra to facilitate the integration of
                    digital data flows at the state and district levels while
                    safeguarding data privacy and security through the
                    establishment of the State Data Authority (“SDA”) to serve
                    as the primary regulator for public sector data, and to be
                    tasked with formulating a comprehensive State Data Policy,
                    ensuring compliance with data standards and exchange
                    protocols, and enhancing data interoperability; (b) the
                    introduction of a data stewardship program through the SDA
                    to coordinate significant data initiatives and build
                    capacity at the state and district level; and (c) for line
                    departments to digitize and publish essential datasets in an
                ...
                <li>
                  ...
                  <p>
                    ...
                    monitoring labor market dynamics and scheme performance; (b)
                    the introduction of a Unified Master Indicator Platform
                    (“Maha Data Bank”), incorporating the Sustainable
                ...
                <li>
                  ...
                  <p>
                    ...
                    Maharashtra Institute for Transformation (“MITRA”) to enable
                    it to lead dialogue and coordinate with concerned line
                    departments and the state decision making agencies on policy
                    reforms, as laid down in the One trillion-dollar Roadmap
                    (“OTD Roadmap”), including through the Asset Monetization
                    (“AM Policy”) to be developed by the Government of
                    Maharashtra; and (b) piloting the implementation of the AM
                    Policy in the tourism sector through commercialization of
                    state government owned tourism properties.
                  </p>
                </li>
              </ul>
            </li>
          </ul>
          <h3>Disburement Linked Indicators Track Record</h3>
          <div className="DLI-Section">
            {DLItabs.map((tab) => (
              <div key={tab} className="DLI-Item">
                <button
